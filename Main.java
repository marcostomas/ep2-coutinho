...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        System.out.println("\tcriterio de filtragem: 'todos' ou 'estoque_menor_igual' ou 'categoria_igual' ou 'entre' ou 'substring'");
        System.out.println("\tparametro de filtragem: argumentos adicionais necessários para a filtragem. Para intervalo, usar a notação '10-15'");
